...
dashboard.section.buttons.val = {
  dashboard.button("<leader> f f", "   File Browser", ":Telescope file_browser <CR>"),
  ...
  dashboard.button("<leader> i p", "   Add/Remove Plugins", ":e ~/.nixpkgs/hm/dotfiles/nvim/lua/user/plugins.lua<CR>"),
